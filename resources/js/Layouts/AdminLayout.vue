            ...
            >
                ...
                >
                    <li class="relative">
                        ...
                        <ul
                            class="show !visible relative m-0 list-none p-0 block"
                        >
                            <li class="relative">
                                <a
                    ...
                    <li class="relative">
                        ...
                        <ul
                            class="show !visible relative m-0 list-none p-0 data-[te-collapse-show]:block"
                        >
                            <li class="relative">
                                <a
                                    href="/admin"
                                    class="flex h-6 cursor-pointer active:underline items-center truncate rounded-[5px] py-4 pl-[3.4rem] pr-6 text-[0.78rem] text-gray-700 outline-none transition duration-300 ease-linear hover:bg-primary-400/10 hover:text-primary-600 hover:outline-none focus:bg-primary-400/10 focus:text-primary-600 focus:outline-none active:bg-primary-400/10 active:text-primary-600 active:outline-none data-[te-sidenav-state-active]:text-primary-600 data-[te-sidenav-state-focus]:outline-none motion-reduce:transition-none dark:text-gray-300 dark:hover:bg-white/10 dark:focus:bg-white/10 dark:active:bg-white/10"
                                    >المنتجات</a
                                >
                            </li>
                ...
                >
                    ...
                    <ul class="relative flex items-center">
                        ...
                        <li class="relative" data-te-dropdown-ref>
                            ...
                            >
                                <img
                                    src="https://tecdn.b-cdn.net/img/Photos/Avatars/img (8).webp"
                                    class="rounded-full"
...
import { Sidenav, Dropdown, Ripple, Tooltip, initTE } from "tw-elements";
